...
export const createClassicFullResume = (): MultiPageTemplate => {
  ...
  currentY += 40
  const work2 = createWorkExperience2()
  page2Components.push(...offsetComponents(work2, currentY - work2[0].y))
  currentY += 190
...
export const createMinimalFullResume = (): MultiPageTemplate => {
  ...
  // 工作经历（续）
  page2Components.push(...createSectionTitle(currentY, '经历（续）'))
  currentY += 40
  const work3 = createWorkExperience2()
  page2Components.push(...offsetComponents(work3, currentY - work3[0].y))
  currentY += 190
  ...
  divider7.stroke = '#d1d5db'
  page2Components.push(divider7)
  currentY += 40
...
export const FULL_TEMPLATES_MULTI_PAGE = {
  ...
  professional: { name: '专业风格', description: '正式专业，适合高级职位', create: createProfessionalFullResume },
}
